...
function listarComunas() {
    ...
    if (regi_codigo != '') {
        ...
        $.ajax({
            type: 'GET',
            url: window.location.origin+'/digitador/crear-iniciativa/listar-comunas',
            data: {
...
function guardarUbicacion() {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/crear-iniciativa/guardar-ubicacion',
        headers: {
...
function listarUbicacion() {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin+'/digitador/crear-iniciativa/listar-ubicacion',
        data: {
            iniciativa: inic_codigo
        },
...
function eliminarUbicacion(inic_codigo, comu_codigo) {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/crear-iniciativa/eliminar-ubicacion',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
...
function mostrarSubentornos() {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/crear-iniciativa/obtener-subentornos',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
...
function agregarSubentorno() {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/crear-iniciativa/guardar-participante',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
...
function listarSubentornos() {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin+'/digitador/crear-iniciativa/listar-subentornos-participantes',
        data: {
            iniciativa: inic_codigo
        },
        success: function(resListar) {
...
function eliminarSubentorno(inic_codigo, sube_codigo) {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/crear-iniciativa/eliminar-subentorno-participante',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
...
function agregarResultado() {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/crear-iniciativa/guardar-resultado',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
...
function listarResultados() {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin+'/digitador/crear-iniciativa/listar-resultados',
        data: {
            iniciativa: inic_codigo
        },
        success: function(resListar) {
...
function eliminarResultado(resu_codigo, inic_codigo) {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/crear-iniciativa/eliminar-resultado',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
