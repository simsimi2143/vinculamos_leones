...
function cargarCantidad() {
    ...
    if (participante != '' && participante != null) {
        ...
        $.ajax({
            type: 'GET',
            url: window.location.origin+'/digitador/iniciativa/cobertura/consultar-cantidad',
            data: {
...
function actualizarParticipante() {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/iniciativa/cobertura/actualizar-participante',
        headers: {
...
function listarParticipantes() {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin+'/digitador/iniciativa/cobertura/listar-participantes',
        data: {
            iniciativa: inic_codigo
        },
...
function eliminarParticipante(inic_codigo, sube_codigo) {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/digitador/iniciativa/cobertura/eliminar-participante',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
