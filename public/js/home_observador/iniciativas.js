...
function iniciativasUnidades() {
	...
	$.ajax({
		type: 'GET',
		url: window.location.origin+'/observador/dashboard/iniciativas/inic-unid',
		data: { 
			regi_codigo: region,
			comu_codigo: comuna
		},
...
function participantesEntornos() {
	...
	$.ajax({
		type: 'GET',
		url: window.location.origin+'/observador/dashboard/iniciativas/part-ento',
		data: { 
			regi_codigo: region,
			comu_codigo: comuna,
            unid_codigo: unidad
...
function inversionPilares() {
	...
	$.ajax({
		type: 'GET',
		url: window.location.origin+'/observador/dashboard/iniciativas/inve-pila',
		data: { 
			regi_codigo: region,
			comu_codigo: comuna,
            unid_codigo: unidad
...
function iniciativasOds() {
	...
	$.ajax({
		type: 'GET',
		url: window.location.origin+'/observador/dashboard/iniciativas/inic-ods',
		data: { 
			regi_codigo: region,
			comu_codigo: comuna,
            unid_codigo: unidad
...
function indiceInvi() {
    ...
    $.ajax({
		type: 'GET',
		url: window.location.origin+'/observador/dashboard/iniciativas/invi',
		data: { 
			regi_codigo: region,
			comu_codigo: comuna,
            unid_codigo: unidad
...
function consultarComunas() {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin+'/observador/iniciativas/comuna',
        data: {
            region: regi_codigo
        },
        success: function(resConsultar) {            
...
function consultarUnidades() {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin+'/observador/iniciativas/unidad',
        data: {
            comuna: comu_codigo
        },
        success: function(resConsultar) {            
