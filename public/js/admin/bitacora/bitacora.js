...
function listarParticipantes() {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin+'/admin/actividad/listar-participantes',
        data: {
...
function agregarParticipantes() {
    ...
    $.ajax({
        type:'POST',
        url:window.location.origin+'/admin/actividad/agregar-participante',
        headers:{
...
function agregarDirigente() {
    ...
    if (diri_codigo != '' && diri_codigo != null) {
        $.ajax({
            type: 'GET',
            url: window.location.origin+'/admin/actividad/obtener-dirigente',
            data: {
                codigo: diri_codigo
            },
            success: function(resListar){
...
function eliminarParticipante(asis_codigo) {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin+'/admin/actividad/eliminar-participante',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {
